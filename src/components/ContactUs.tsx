...
const   ContactUs = () => {
  ...
  <div className="flex flex-wrap justify-center md:justify-between items-start w-full max-w-6xl">
    ...
    >
      ...
      <div>
        <label className="block text-sm font-medium text-black pl-1">Name</label>
        <input
          type="text"
          value={name}
          onChange={(e) => setName(e.target.value)}
          required
          className="text-black border border-gray-800 mb-4 mt-2 w-[35vh] md:w-[30vw] px-4 py-2 rounded-[2vw] max-sm:rounded-[6vw]"
        />
      </div>
      <div>
        <label className="block text-sm font-medium text-black pl-1">Email</label>
        <input
          type="email"
          value={email}
      ...
      <div>
        <label className="block text-sm font-medium text-black pl-1">Description</label>
        <textarea
          value={description}
      ...
      <div>
        <label className="block text-sm font-medium text-black pl-1">
          Attachment (optional)
        </label>
        <input
          type="file"
      ...
      <Button
        ...
        className="border px-5 mb-5 border-gray-800 rounded-[2vw] max-sm:rounded-[6vw] hover:bg-blue-400 hover:text-white hover:border-none ease-linear duration-200">
