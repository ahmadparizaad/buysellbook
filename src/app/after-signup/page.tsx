...
function AfterSignUp() {
  ...
  return (
    <div className="text-xl font-[Gilroy] min-h-[100vh] font-semibold mx-3 mt-56 text-center">
      ...
      <button
        className="border-2 border-gray-700 my-5 dark:border-white/[0.3] rounded-[2vw] max-sm:rounded-[6vw] hover:bg-red-400 hover:text-white hover:border-none ease-linear duration-200 px-4 py-2 disabled:opacity-50 disabled:cursor-not-allowed"
